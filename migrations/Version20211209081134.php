 ...
 */
final class Version20211209081134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subscription (id INT AUTO_INCREMENT NOT NULL, package VARCHAR(255) NOT NULL, expirate TINYINT(1) NOT NULL, subscription_date DATETIME NOT NULL, renewal_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
